...
class TestWenCai(unittest.TestCase):
    ...
    def test_get_scrape_report(self):
        r = wc.get_scrape_report(query='上证指数上穿10日均线', start_date='2019-10-01', end_date='2019-10-19', period='1,2,3,4',
                                 benchmark='hs000300')
    ...
    def test_get_event_evaluate(self):
        r = wc.get_event_evaluate(end_date='2019-07-16', index_code="1a0001", period='1', query="上证指数上穿10日均线",
